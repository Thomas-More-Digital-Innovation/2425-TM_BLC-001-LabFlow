...
<div class="flex flex-col w-full ml-5">
    ...
    <div class="bg-slate-100 w-full h-full rounded-2xl p-5">
        ...
        <div class="space-y-3">
            <!-- Header -->
            <div class="grid grid-cols-9 bg-gray-300 rounded-lg h-10 items-center px-3 font-bold space-x-3">
            ...
            <div class="grid grid-cols-9 space-x-3 bg-white rounded-lg h-20 items-center px-3 shadow-md">
                ...
                <div class="col-span-1">
                    <input type="text" id="StaalCode" bind:value={StaalCode} class="bg-gray-100 rounded-lg h-14 text-lg pl-3 w-full  
                    {errorVeldenStaalPOST.staalcode ? 'border-2 border-red-500' : ''}" />
                </div>
                <div class="col-span-1">
                    <input type="text" id="patientAchternaam" bind:value={patientAchternaam} class="bg-gray-100 rounded-lg h-14 text-lg pl-3 w-full  
                    {errorVeldenStaalPOST.naam ? 'border-2 border-red-500' : ''}" />
                </div>
                <div class="col-span-1">
                    <input type="text" id="patientVoornaam" bind:value={patientVoornaam} class="bg-gray-100 rounded-lg h-14 text-lg pl-3 w-full  
                ...
                <div class="col-span-1">
                    <input type="text" id="laborantNaam" bind:value={laborantNaam} class="bg-gray-100 rounded-lg h-14 text-lg pl-3 w-full  
                    {errorVeldenStaalPOST.laborantNaam ? 'border-2 border-red-500' : ''}" />
                </div>
                <div class="col-span-1">
                    <input type="text" id="laborantRnummer" bind:value={laborantRnummer} class="bg-gray-100 rounded-lg h-14 text-lg pl-3 w-full  
                    {errorVeldenStaalPOST.laborantRnummer ? 'border-2 border-red-500' : ''}" />
                </div>

                <!-- Acties -->
                <div class="col-span-1 flex justify-end">
                    <button type="button" class="h-10 w-10 bg-green-500 p-2 rounded-lg text-white" 
                    on:click={nieuweStaal} aria-label="Nieuwe categorie toevoegen">
                        <FaPlus />
                    </button>
                </div>
            </div>
            ...
            <div class="space-y-3">
                {#each filteredStalen as staal, index}
                    <div class="grid grid-cols-9 bg-white rounded-lg h-20 items-center px-3 shadow-md space-x-3">
